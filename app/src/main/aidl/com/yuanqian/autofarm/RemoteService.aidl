...
import com.yuanqian.autofarm.remote.PermissionStateInfo;
...
interface RemoteService {
    ...
    boolean startActivityOnDisplay(in Intent intent, int displayId) = 36;
    boolean forceStopApp(String packageName) = 37;
    boolean inputText(String text) = 38;
    ...
    // 物理屏截图（screencap），返回保存的绝对路径，失败返回 null
    String capturePhysicalPng(String dirPath) = 39;
}

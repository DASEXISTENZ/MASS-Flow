package com.mas.autofarm.schedule.model

/**
 * 定时/外部启动相关 Intent 常量与倒计时默认值
 * Intent 映射见 [com.mas.autofarm.schedule.LaunchIntentMapper]
 */
object ScheduledExecutionRequest {
    const val ACTION_SHOW_SCHEDULE_EXECUTION =
        "com.mas.autofarm.action.SHOW_SCHEDULE_EXECUTION"
    const val ACTION_LAUNCH_PROFILE =
        "com.mas.autofarm.action.LAUNCH_PROFILE"

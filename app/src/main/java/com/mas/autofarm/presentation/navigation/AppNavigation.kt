...
import com.mas.autofarm.domain.launch.LaunchEffect
...
import com.mas.autofarm.presentation.LocalToaster
...
import com.mas.autofarm.presentation.view.notification.NotificationSettingsView
import com.mas.autofarm.presentation.view.settings.ErrorLogView
import com.mas.autofarm.presentation.view.settings.LogHistoryView
import com.mas.autofarm.presentation.view.settings.TaskOverrideEditorView
...
import com.mas.autofarm.schedule.ui.CountdownDialog
import com.mas.autofarm.schedule.ui.ScheduleEditView
import com.mas.autofarm.schedule.ui.ScheduleTriggerLogView
        ...
        CompositionLocalProvider(LocalToaster provides toaster) {
            NavHost(
                ...
                composable(Routes.WORKSHOP) {
                    com.mas.autofarm.presentation.view.workshop.WorkshopScreen()
                }
            }
        }

...
data class WakeUpConfig(
    ...
    companion object {
         ...
         * 客户端类型选项值列表
         */
        val CLIENT_TYPES: List<String> get() = com.mas.autofarm.constant.Packages.clientTypes
        /** 默认客户端：取当前适配配置（game.json）的第一个客户端类型 */
        val DEFAULT_CLIENT_TYPE: String get() = com.mas.autofarm.constant.Packages.clientTypes.firstOrNull() ?: ""

 ...
 * Intent 映射见 [com.yuanqian.autofarm.schedule.LaunchIntentMapper]
 */
object ScheduledExecutionRequest {
    const val ACTION_SHOW_SCHEDULE_EXECUTION =
        "com.yuanqian.autofarm.action.SHOW_SCHEDULE_EXECUTION"
    const val ACTION_LAUNCH_PROFILE =
        "com.yuanqian.autofarm.action.LAUNCH_PROFILE"

...
import com.yuanqian.autofarm.domain.service.resolveStartResultMessage
...
import com.yuanqian.autofarm.schedule.model.ExecutionResult
...
class StartTaskChainUseCase(
    ...
    private suspend fun recordFailure(message: String) {
        runCatching {
            ...
            sessionLogger.append(message, com.yuanqian.autofarm.data.model.LogLevel.ERROR)
    ...
    private suspend fun runLocalFlow(name: String): Result {
        ...
        if (!projFile.exists()) {
            return Result.Failed(
                ...
                message = com.yuanqian.autofarm.utils.i18n.uiTextDynamic(
        ...
        return runCatching {
            ...
            val templates = com.yuanqian.autofarm.presentation.view.workshop.TemplateStore.listAll(appContext)
            ...
            if (remote == null) {
                return Result.Failed(
                    executionResult = ExecutionResult.FAILED_VALIDATION,
                    message = com.yuanqian.autofarm.utils.i18n.uiTextDynamic("服务未连接，无法运行本地流程"),
                )
            }
            ...
            if (engine.state == com.yuanqian.autofarm.presentation.view.workshop.FlowEngine.EngineState.ERROR) {
                Result.Failed(
                    ...
                    message = com.yuanqian.autofarm.utils.i18n.uiTextDynamic("本地流程执行出错"),
                )
            } else {
                Result.Success
            }
            ...
            Result.Failed(
                executionResult = ExecutionResult.FAILED_START,
                message = com.yuanqian.autofarm.utils.i18n.uiTextDynamic("本地流程执行异常：${e.message}"),
            )
        }
    }

package com.yuanqian.autofarm.data.config

import android.content.Context
import com.alibaba.fastjson2.JSON
import com.yuanqian.autofarm.constant.MaaFiles.APP_VERSION_FILE
import com.yuanqian.autofarm.constant.MaaFiles.ASSET_VERSION_FILE
import com.yuanqian.autofarm.constant.MaaFiles.CACHE
import com.yuanqian.autofarm.constant.MaaFiles.DEBUG
import com.yuanqian.autofarm.constant.MaaFiles.MAA
import com.yuanqian.autofarm.constant.MaaFiles.OVERRIDES
import com.yuanqian.autofarm.constant.MaaFiles.RESOURCE
import com.yuanqian.autofarm.constant.MaaFiles.SCREENSHOTS
import com.yuanqian.autofarm.constant.MaaFiles.VERSION_FILE
...
class MaaPathConfig(private val context: Context) {
    ...
    /** 截图目录：公共下载目录（用户易找），App 截图按钮保存到此 */
    val debugScreenshotsDir: String by lazy {
        File("/sdcard/Download/元前挂机/截图").absolutePath
    }

package com.yuanqian.autofarm.presentation.view.home
...
fun HomeView(
    ...
    // 任务执行状态
    val compositionService: com.yuanqian.autofarm.domain.service.MaaCompositionService = koinInject()
    ...
    // 资源状态
    val resOk = uiState.resourceInitState is com.yuanqian.autofarm.domain.state.ResourceInitState.Ready
    ...
    LazyColumn(
        ...
        item {
            Row(horizontalArrangement = Arrangement.spacedBy(12.dp)) {
                ...
                ) { navController.navigate(com.yuanqian.autofarm.constant.Routes.BACKGROUND_TASK) }
                QuickCard(
                    title = "🧰 脚本工坊",
                    subtitle = "制作工作流",
        ...
        item {
            Row(horizontalArrangement = Arrangement.spacedBy(12.dp)) {
                QuickCard(
                    ...
                    modifier = Modifier.weight(1f),
                ) { navController.navigate(com.yuanqian.autofarm.constant.Routes.SCHEDULE) }
                QuickCard(
                    title = "⚙ 设置",
                    subtitle = "权限与偏好",
                    color = Color(0xFF607D8B),
                    modifier = Modifier.weight(1f),
                ) { navController.navigate(com.yuanqian.autofarm.constant.Routes.SETTINGS) }
            }
        }
        // ===== 最近流程 =====
        item {

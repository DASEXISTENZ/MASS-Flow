...
FlowNodeKind.APP_STATE -> {
    ...
    private suspend fun executeInfo(node: FlowNode) {
        ...
        try {
            ...
            if (node.resolution.isNotBlank()) {
                val res = com.yuanqian.autofarm.constant.DefaultDisplayConfig.resolveResolution(
                    node.resolution, com.yuanqian.autofarm.constant.DefaultDisplayConfig.ResolutionPreference.valueOf(node.resolution)
                )
    ...
    private fun linkTypeLabel(type: com.yuanqian.autofarm.presentation.view.workshop.LinkType): String = when (type) {
        com.yuanqian.autofarm.presentation.view.workshop.LinkType.SEQUENCE -> "顺序"
        com.yuanqian.autofarm.presentation.view.workshop.LinkType.YES -> "是"
        com.yuanqian.autofarm.presentation.view.workshop.LinkType.NO -> "非"
        com.yuanqian.autofarm.presentation.view.workshop.LinkType.AND -> "与"
        com.yuanqian.autofarm.presentation.view.workshop.LinkType.OR -> "或"
    }

...
import com.yuanqian.autofarm.ITouchEventCallback
import com.yuanqian.autofarm.MaaCoreService
import com.yuanqian.autofarm.RemoteService
import com.yuanqian.autofarm.bridge.NativeBridgeLib
import com.yuanqian.autofarm.constant.DefaultDisplayConfig
import com.yuanqian.autofarm.constant.DisplayMode
import com.yuanqian.autofarm.maa.InputControlUtils
import android.content.Intent
import com.yuanqian.autofarm.remote.internal.ActivityUtils
import com.yuanqian.autofarm.remote.internal.GameAudioMuteController
import com.yuanqian.autofarm.remote.internal.PermissionGrantHelper
import com.yuanqian.autofarm.remote.internal.PowerController
import com.yuanqian.autofarm.remote.internal.PrimaryDisplayManager
import com.yuanqian.autofarm.remote.internal.RemoteUtils
import com.yuanqian.autofarm.remote.internal.ScreenManager
import com.yuanqian.autofarm.remote.internal.VirtualDisplayManager
import com.yuanqian.autofarm.remote.internal.WakeUnlockController
import com.yuanqian.autofarm.third.FakeContext
import com.yuanqian.autofarm.third.Ln
import com.yuanqian.autofarm.third.Workarounds
import java.io.File
...
class RemoteServiceImpl : RemoteService.Stub() {
    ...
    /** @return [com.yuanqian.autofarm.constant.WakeUnlockResult] */
    ...
    override fun forceStopApp(packageName: String): Boolean = runCatching {
        com.yuanqian.autofarm.third.wrappers.ServiceManager.getActivityManager()
            .forceStopPackage(packageName)
        true
    }.getOrDefault(false)

    override fun inputText(text: String): Boolean = runCatching {
        val displayId = com.yuanqian.autofarm.remote.internal.VirtualDisplayManager.getDisplayId()
        if (displayId == com.yuanqian.autofarm.constant.DefaultDisplayConfig.DISPLAY_NONE) return false
        text.forEach { c ->
            val key = charToKeyCode(c) ?: return@forEach
            com.yuanqian.autofarm.maa.InputControlUtils.keyDown(key, displayId)
            com.yuanqian.autofarm.maa.InputControlUtils.keyUp(key, displayId)
        }
        true
    }.getOrDefault(false)
